...
**Inversion of Control (IoC)** - Архітектурне рішення, що дозволяє делегувати управління програмою самому фреймворку (своєрідний аутсорс), яке використовують для зменшення зв'язаності елементів програми та спрощення масштабування можливостей системи. 
