...
| переваги      | За рахунок незмінності хеш код кешується, його не потрібно щоразу обчислювати. Це дає високу продуктивність при використанні в якості клча Hash map. | Не забиває пам'ять сміттям.       | Не забиває пам'ять сміттям.       |
